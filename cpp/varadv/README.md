...
- For varadvection: set pde ="varadv", set domain [ -1, 1]X[-1,1], adv velocity a(x,y) = ( -y,x), Final time  pi/2,  ic = "expo", cfl = 0.5
- For linadvection: set pde ="linear", set domain [-1,1]X[-1,1], adv velocity a(x,y) = ( 1,1), Final time  1, ic = "sin", cfl = 0.5
- In fact you can compute the error convergence at any preferred time.
