...
- For varadvection: set domain [ -1, 1]X[-1,1], adv velocity a(x,y) = ( -y,x), Final time  2*pi,  ic = "expo", cfl = 0.5
- For linadvection: set domain [-1,1]X[-1,1], adv velocity a(x,y) = ( 1,1), Final time  1, ic = "sin", cfl = 0.5
